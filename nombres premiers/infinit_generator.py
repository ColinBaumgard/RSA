...
def creer_nombres_premier(commencer):
    suite_premiers = []
    ...
    while 1:
        if est_premier(i) == 1:
            ...
            if k >= j + 10000 :
                ...
                print(k," nombres générés ; dernier nombre : ", dernier_ecrit) # on affiche le %
...
creer_nombres_premier(eval(input("Commencer à : "))) #on creer des nombres premiers
